    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="py-20" style={{ backgroundColor: accentColor }}>
        <div className="container mx-auto px-6 text-center">
          ...
          <a href="https://wa.me/5571983982572?text=Olá, vim através ddo site MvKGymCPL e quero conhecer mais detalhes do site e quero agendar uma demonstração." target="_blank">
...
function PriceCard({ title, price, features, featured = false }: PriceCardProps) {
  ...
  return (
    ...
    style={{ 
      ...
      <a href="https://wa.me/5571983982572?text=Olá, vim através ddo site MvKGymCPL  e quero conhecer mais detalhes do site e quero assinar a pltaforma." target="_blank">
      <button className={`
